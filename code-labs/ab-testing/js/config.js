// ============================================================
// CONFIG & CONSTANTS — A/B Testing 1 (X-Ray / Assemble / Rewire)
// ============================================================
...
export const GAME = {
  ...
  TAGLINE: 'Learn A/B testing through interactive code labs',
  DB_TABLE: 'code_lab_events',
  DB_SCORES_TABLE: 'code_lab_scores',
  STORAGE_KEY: 'abtest_trace_1_progress',
};
...
// --- Grades ---
export const GRADES = [
  { min: 0.95, grade: 'S', label: 'Experiment Master' },
  { min: 0.85, grade: 'A', label: 'Data Scientist' },
  { min: 0.75, grade: 'B', label: 'Analyst' },
...
export const BADGES = {
  ...
  tensor_whisperer: { name: 'Experiment Pro',      desc: 'Earn an S grade on any lesson' },
};

// --- Chapter Definitions ---
export const CHAPTERS = [
  { id: 'explore', name: 'Explore Data', description: 'Load the experiment data and compute click rates.', lessonStart: 0, lessonCount: 3 },
  { id: 'test', name: 'Test It', description: 'Build contingency tables and run chi-square tests.', lessonStart: 3, lessonCount: 3 },
  { id: 'advanced', name: 'Go Deeper', description: 'Add controls and test for interaction effects.', lessonStart: 6, lessonCount: 2 },
];
