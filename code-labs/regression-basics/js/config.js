// ============================================================
// CONFIG & CONSTANTS — Linear Regression 1 (X-Ray / Assemble / Rewire)
// ============================================================
...
export const GAME = {
  ...
  TAGLINE: 'Learn regression through interactive code labs',
  DB_TABLE: 'code_lab_events',
  DB_SCORES_TABLE: 'code_lab_scores',
  STORAGE_KEY: 'linreg_trace_1_progress',
};
...
export const CHAPTERS = [
  { id: 'explore', name: 'Explore Data', description: 'Load, visualize, and understand your data.', lessonStart: 0, lessonCount: 3 },
  { id: 'model', name: 'Fit a Model', description: 'Build and interpret a linear model.', lessonStart: 3, lessonCount: 3 },
  { id: 'evaluate', name: 'Evaluate', description: 'Check model quality and make predictions.', lessonStart: 6, lessonCount: 2 },
];
