// ============================================================
// CONFIG & CONSTANTS — Discrete Choice 1 (X-Ray / Assemble / Rewire)
// ============================================================
...
export const GAME = {
  ...
  TAGLINE: 'Learn binary choice models through interactive code labs',
  DB_TABLE: 'code_lab_events',
  DB_SCORES_TABLE: 'code_lab_scores',
  STORAGE_KEY: 'dchoice_trace_1_progress',
};
...
export const COL = {
  ...
  SYN_BUILTIN: '#82AAFF',  // blue — pd, np, print, range, len
...
// --- Grades ---
export const GRADES = [
  { min: 0.95, grade: 'S', label: 'Choice Master' },
  { min: 0.85, grade: 'A', label: 'Decision Analyst' },
...
export const BADGES = {
  ...
  tensor_whisperer: { name: 'Choice Pro',          desc: 'Earn an S grade on any lesson' },
};

// --- Chapter Definitions ---
export const CHAPTERS = [
  { id: 'binary_basics', name: 'Binary Outcomes', description: 'Understand binary data and the S-curve.', lessonStart: 0, lessonCount: 3 },
  { id: 'classification', name: 'Classification', description: 'Predict and evaluate binary outcomes.', lessonStart: 3, lessonCount: 3 },
  { id: 'evaluation', name: 'Advanced Evaluation', description: 'ROC curves and feature importance.', lessonStart: 6, lessonCount: 2 },
];
