// ============================================================
// CONFIG & CONSTANTS — PyTorch 3 (X-Ray / Assemble / Rewire)
// ============================================================
...
export const GAME = {
  ...
  TAGLINE: 'Master custom models through interactive code labs',
  DB_TABLE: 'code_lab_events',
  DB_SCORES_TABLE: 'code_lab_scores',
  STORAGE_KEY: 'pytorch_trace_3_progress',
};
...
// --- Grades ---
export const GRADES = [
  { min: 0.95, grade: 'S', label: 'Module Master' },
  { min: 0.85, grade: 'A', label: 'Deep Architect' },
  { min: 0.75, grade: 'B', label: 'Layer Builder' },
...
export const BADGES = {
  ...
  tensor_whisperer: { name: 'Architecture Pro',   desc: 'Earn an S grade on any lesson' },
};

// --- Chapter Definitions ---
export const CHAPTERS = [
  { id: 'custom_modules', name: 'Custom Modules', description: 'Build your own nn.Module classes.', lessonStart: 0, lessonCount: 3 },
  { id: 'regularization', name: 'Regularization', description: 'Dropout, BatchNorm, and scheduling.', lessonStart: 3, lessonCount: 3 },
  { id: 'production', name: 'Production', description: 'Save, load, and transfer learning.', lessonStart: 6, lessonCount: 2 },
];
