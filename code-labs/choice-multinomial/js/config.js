// ============================================================
// CONFIG & CONSTANTS — Discrete Choice 2 (X-Ray / Assemble / Rewire)
// ============================================================
...
export const GAME = {
  ...
  TAGLINE: 'Master multinomial choice models through interactive code labs',
  DB_TABLE: 'code_lab_events',
  DB_SCORES_TABLE: 'code_lab_scores',
  STORAGE_KEY: 'dchoice_trace_2_progress',
};
...
export const COL = {
  ...
  SYN_BUILTIN: '#82AAFF',  // blue -- np, sm, print, range, len
...
// --- Grades ---
export const GRADES = [
  { min: 0.95, grade: 'S', label: 'Market Master' },
  { min: 0.85, grade: 'A', label: 'Choice Analyst' },
  { min: 0.75, grade: 'B', label: 'Model Builder' },
...
export const BADGES = {
  ...
  tensor_whisperer: { name: 'Market Pro',          desc: 'Earn an S grade on any lesson' },
};

// --- Chapter Definitions ---
export const CHAPTERS = [
  { id: 'softmax', name: 'Softmax & Shares', description: 'From utilities to market shares.', lessonStart: 0, lessonCount: 3 },
  { id: 'interpret', name: 'Interpret Results', description: 'WTP, shares, and the IIA problem.', lessonStart: 3, lessonCount: 3 },
  { id: 'simulate', name: 'Simulate Markets', description: 'What-if scenarios and optimal pricing.', lessonStart: 6, lessonCount: 2 },
];

// --- Stage / Lesson Names ---
export const STAGE_NAMES = [
  'Softmax Probabilities',
  'Price Changes Shares',
