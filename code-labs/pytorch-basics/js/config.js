// ============================================================
// CONFIG & CONSTANTS — PyTorch Trace (X-Ray / Assemble / Rewire)
// ============================================================
...
export const GAME = {
  ...
  TAGLINE: 'Learn PyTorch through interactive code labs',
  DB_TABLE: 'code_lab_events',
  DB_SCORES_TABLE: 'code_lab_scores',
  STORAGE_KEY: 'pytorch_trace_progress',
};
...
// --- Grades ---
export const GRADES = [
  { min: 0.95, grade: 'S', label: 'Tensor Master' },
  { min: 0.85, grade: 'A', label: 'Deep Learner' },
  { min: 0.75, grade: 'B', label: 'Gradient Guru' },
...
export const BADGES = {
  ...
  tensor_whisperer: { name: 'Tensor Whisperer',   desc: 'Earn an S grade on any lesson' },
};

// --- Chapter Definitions ---
export const CHAPTERS = [
  { id: 'tensors_and_models', name: 'Tensors & Models', description: 'Build your first neural network.', lessonStart: 0, lessonCount: 3 },
  { id: 'training', name: 'Training', description: 'Teach the model to learn.', lessonStart: 3, lessonCount: 3 },
  { id: 'real_pipeline', name: 'Real Pipeline', description: 'Use real data and modern architectures.', lessonStart: 6, lessonCount: 2 },
];
