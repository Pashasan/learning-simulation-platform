// ============================================================
// CONFIG & CONSTANTS — GPT 2 (X-Ray / Assemble / Rewire)
// ============================================================
...
export const GAME = {
  ...
  TAGLINE: 'Master LM training and generation through interactive code labs',
  DB_TABLE: 'code_lab_events',
  DB_SCORES_TABLE: 'code_lab_scores',
  STORAGE_KEY: 'gpt_trace_2_progress',
};
...
// --- Grades ---
export const GRADES = [
  { min: 0.95, grade: 'S', label: 'Generation Master' },
  { min: 0.85, grade: 'A', label: 'LM Architect' },
...
export const BADGES = {
  ...
  tensor_whisperer: { name: 'Generation Pro',      desc: 'Earn an S grade on any lesson' },
};

// --- Chapter Definitions ---
export const CHAPTERS = [
  { id: 'training', name: 'Training LMs', description: 'Teach the model to predict tokens.', lessonStart: 0, lessonCount: 3 },
  { id: 'generation', name: 'Text Generation', description: 'Sample text from the model.', lessonStart: 3, lessonCount: 3 },
  { id: 'architecture', name: 'Architecture', description: 'Multi-head attention and layer norm.', lessonStart: 6, lessonCount: 2 },
];
