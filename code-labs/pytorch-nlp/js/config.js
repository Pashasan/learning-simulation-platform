// ============================================================
// CONFIG & CONSTANTS — PyTorch 2 (NLP Code Lab)
// ============================================================
...
export const GAME = {
  ...
  TAGLINE: 'Learn NLP with PyTorch through interactive code labs',
  DB_TABLE: 'code_lab_events',
  DB_SCORES_TABLE: 'code_lab_scores',
  STORAGE_KEY: 'pytorch_trace_2_progress',
};
...
// --- Grades ---
export const GRADES = [
  { min: 0.95, grade: 'S', label: 'NLP Master' },
  { min: 0.85, grade: 'A', label: 'Text Analyst' },
  { min: 0.75, grade: 'B', label: 'Sequence Builder' },
...
export const BADGES = {
  ...
  tensor_whisperer: { name: 'NLP Pro',             desc: 'Earn an S grade on any lesson' },
};

// --- Chapter Definitions ---
export const CHAPTERS = [
  { id: 'text_data', name: 'Text as Data', description: 'Turn words into numbers.', lessonStart: 0, lessonCount: 3 },
  { id: 'sequence_models', name: 'Sequence Models', description: 'RNNs and text classification.', lessonStart: 3, lessonCount: 3 },
  { id: 'applications', name: 'Applications', description: 'Similarity and generation.', lessonStart: 6, lessonCount: 2 },
];
