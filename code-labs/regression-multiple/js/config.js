// ============================================================
// CONFIG & CONSTANTS — Linear Regression 2 (X-Ray / Assemble / Rewire)
// ============================================================
...
export const GAME = {
  ...
  TAGLINE: 'Master multiple regression through interactive code labs',
  DB_TABLE: 'code_lab_events',
  DB_SCORES_TABLE: 'code_lab_scores',
  STORAGE_KEY: 'linreg_trace_2_progress',
};
...
export const COL = {
  ...
  SYN_BUILTIN: '#82AAFF',  // blue — pd, np, sm, print, range, len
...
// --- Grades ---
export const GRADES = [
  { min: 0.95, grade: 'S', label: 'Stats Master' },
  { min: 0.85, grade: 'A', label: 'Data Analyst' },
...
export const BADGES = {
  ...
  tensor_whisperer: { name: 'Stats Pro',           desc: 'Earn an S grade on any lesson' },
};

// --- Chapter Definitions ---
export const CHAPTERS = [
  { id: 'multiple_x', name: 'Multiple Variables', description: 'Add more predictors to your model.', lessonStart: 0, lessonCount: 3 },
  { id: 'transforms', name: 'Transforms', description: 'Log transforms and elasticity.', lessonStart: 3, lessonCount: 3 },
  { id: 'compare', name: 'Compare Models', description: 'Pick the best model.', lessonStart: 6, lessonCount: 2 },
];
